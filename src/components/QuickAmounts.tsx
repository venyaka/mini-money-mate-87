    ...
    <div className="px-6 mb-8">
      <div className="bg-gray-800/30 rounded-2xl p-4 backdrop-blur-sm">
        <input
          ...
          className="w-full bg-transparent text-white text-lg p-4 rounded-xl border border-gray-600 focus:border-green-400 focus:outline-none mb-4 transition-colors"
        />
